shinyUI(pageWithSidebar(  
     headerPanel("Property Searching Shiny App"),  
     sidebarPanel(    
          sliderInput("FINALACTUA_INPUT", "Assessed Property Value (USD):", min = 100000, max = 510000, pre = "$", value = c(250000,400000)),
          sliderInput('ACTUALYEAR_INPUT', 'Minimum Year Built', value = 1995, min = 1900, max = 2015, step = 5, sep = ""),
